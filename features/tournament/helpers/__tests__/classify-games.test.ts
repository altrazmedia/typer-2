...
describe("classifyGames", () => {
  ...
  it("sorts upcoming ascending by kickoff (closest first)", () => {
    const now = new Date("2026-04-27T12:00:00.000Z");
    const later = { id: "2", kickoffAt: new Date("2026-04-30T12:00:00.000Z") };
    const sooner = { id: "1", kickoffAt: new Date("2026-04-28T12:00:00.000Z") };
  ...
  it("sorts finished descending by kickoff (newest first)", () => {
    const now = new Date("2026-04-27T12:00:00.000Z");
    const older = { id: "1", kickoffAt: new Date("2026-04-20T12:00:00.000Z") };
    const newer = { id: "2", kickoffAt: new Date("2026-04-25T12:00:00.000Z") };

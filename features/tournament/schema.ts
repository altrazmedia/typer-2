...
export function parseCreateTournamentBody(body: unknown): CreateTournamentInput | null {
...
export function parseUpdateTournamentBody(body: unknown): UpdateTournamentInput | null {
  if (!body || typeof body !== "object") return null;
  const o = body as Record<string, unknown>;

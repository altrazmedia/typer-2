  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await fetch(`/api/tournaments/${tournamentId}`, {
      ...
      body: JSON.stringify({
        ...
        exactScorePoints: Number.isFinite(exactScorePoints) ? exactScorePoints : undefined,
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Zmień nazwę, sezon lub zasady punktacji.</DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="edit-tournament-name">Nazwa turnieju</Label>
              <Input
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="edit-tournament-season">Sezon (opcjonalnie)</Label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <Label htmlFor="edit-exact-points">Punkty za dokładny wynik</Label>
                <Input
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="edit-outcome-points">Punkty za trafiony wynik</Label>
                <Input

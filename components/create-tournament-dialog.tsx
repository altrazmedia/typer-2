  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await fetch("/api/tournaments", {
      ...
      body: JSON.stringify({
        ...
        exactScorePoints: Number.isFinite(exactScorePoints) ? exactScorePoints : 3,
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Grupa: <span className="font-medium text-foreground">{groupName}</span>
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <Label htmlFor="tournament-season">Sezon (opcjonalnie)</Label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <Label htmlFor="exact-points">Punkty za dokładny wynik</Label>
                <Input
                  id="exact-points"
              ...
              <div className="flex flex-col gap-2">
                <Label htmlFor="outcome-points">Punkty za trafiony wynik</Label>
                <Input
                  id="outcome-points"
